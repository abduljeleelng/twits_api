...
return [
     ...
     */
    'title' =>"Twits Application",

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => 'documentation for the Twits API',

    /*
     * The base URL displayed in the docs. If this is empty, Scribe will use the value of config('app.url').
     */
    'base_url' => 'https://tweetis-api.herokuapp.com',
    ...
    'try_it_out' => [
         ...
         */
        'base_url' => 'https://unglobal.ng/expense/betal/api',
    ],
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'You can retrieve your token by login with your email and password,  <b>token will come along with your details</b>.',
    ],
