...
<div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"> Password Reset Request </div>
                                    ...
                                    <table role="presentation" style="border-collapse:collapse;border-spacing:0px;" cellspacing="0" cellpadding="0" border="0">
                                        ...
                                        <tr>
                                            <td style="width:550px;">
                                                <img alt="welcome " src="https://images.unsplash.com/photo-1503792243040-7ce7f5f06085?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=80" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:14px;" width="550" height="auto" />
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                ...
                                <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                                    ...
                                    <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                        <table role="presentation" style="vertical-align:top;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tbody><tr>
                                                <td style="font-size:0px;padding:10px 25px;word-break:break-word;" align="left">
                                                    <div style="font-family:Alata;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                                        <h1 style="margin: 0; font-size: 32px; line-height: 40px;">Hi {{$user->name}}! <br />Need to Reset your password?</h1>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table role="presentation" style="border-collapse:separate;line-height:100%;" cellspacing="0" cellpadding="0" border="0">
                                                        <tbody><tr>
                                                            <td role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#ea4a40;" valign="middle" bgcolor="#ea4a40" align="center">
                                                                <a href="{{env('WEB_URL')}}/auth/reset/{{$user->reset}}" style="display: inline-block; background: #ea4a40; color: #ffffff; font-family: Alata; font-size: 14px; font-weight: bold; line-height: 30px; margin: 0; text-decoration: none; text-transform: uppercase; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 3px;" target="_blank"> Reset your password </a>
                                                            </td>
                                                        </tr>
                                                        </tbody></table>
                                                </td>
                                            ...
                                            <tr>
                                                <td style="font-size:0px;padding:10px 25px;word-break:break-word;" align="left">
                                                    <div style="font-family:Alata;font-size:14px;font-weight:400;line-height:24px;text-align:left;color:#333333;">Have questions or need help? Email us at <a href="#" style="color: #ea4a40; text-decoration: none;"> abduljeleelng@gmail.com </a></div>
                                                </td>
                                            </tr>
                                            </tbody></table>
                                    </div>
                                            ...
                                            <tr>
                                                <td style="font-size:0px;padding:10px 25px;word-break:break-word;" align="center">
                                                    <table role="presentation" style="border-collapse:collapse;border-spacing:0px;" cellspacing="0" cellpadding="0" border="0">
                                                        ...
                                                        <tr>
                                                            <td style="width:50px;">
                                                                <img alt="image description" src="{{env('WEB_URL')}}/logo.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:14px;" width="50" height="auto" />
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
